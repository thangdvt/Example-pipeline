...
*/
def project = "FHO.PID.Php-Linux-COV-Example"
...
/** COVERITY PROPERTIES
* cov_key: Authentication key 
* cov_server: Server name
* analysis: commandline analyze issues
* coverity_exclude : Use to exclude folder or file 
*/
def cov_key = "pipelinetemplate.key"
def cov_server = "${SERVER_COVERITY1}"
def analysis = "--distrust-all -en HARDCODED_CREDENTIALS"
...
def blackduck_token = " "
def blackduck_exclude = "output,covoutput"
...
pipeline {
    ...
    */
    environment {
        ...
        COVERITY_HOME = '/opt/cov-analysis-linux64-2020.06'
    ...
    */
    stages {
        ...
        */
        stage("Scan Coverity"){
            steps{
                    sh "cov-configure --php -c config.xml"
