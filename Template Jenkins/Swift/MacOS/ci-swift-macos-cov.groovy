...
def analysis = "--distrust-all -en PARSE_ERROR"
...
pipeline {
    ...
    */
    environment {
        ...
        COVERITY_HOME = '/opt/cov-analysis-linux64-2018.12'
    ...
    stages {
       ...
       */
        ...
        */
        stage('Scan Coverity'){
            steps{
                sh "cov-configure --swift -c config.xml"
                sh "cov-build --dir covoutput -c config.xml swift build"
